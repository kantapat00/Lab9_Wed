package th.ac.tu.siit.ict.its333.myapplication;
...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMapLongClickListener,LocationListener{
    ...
    private void setUpMap() {
       ...
       /* LatLng BKK =new LatLng(13.7563,100.5018);
        LatLng BKK2 =new LatLng(22.2783, 114.1747);
    ...
    // set location in emu >> terminal >> telnet localhost 554
    //                                           |server|  |part|
    //terminal>>geo fix <long> <lat>
}
